...
object Plates {
    ...
    private val plates: List<Plate> = listOf(
            Plate(0, "Entrante", "Rollitos de salmón con queso Philadelphia",
                    7.00F, arrayOf(R.drawable.a1, R.drawable.a4), R.drawable.plato0,
            ...
            Plate(1, "Entrante", "Hojaldres de atún con tomate",
                    6.50F, arrayOf(R.drawable.a0, R.drawable.a1, R.drawable.a4), R.drawable.plato1,
            ...
            Plate(2, "Entrante", "Tartaletas de pisto horneadas",
                    5.00F, arrayOf(R.drawable.a0, R.drawable.a5), R.drawable.plato2,
            ...
            Plate(4, "Primero", "Ensalada Cesar",
                    7.00F, arrayOf(R.drawable.a0, R.drawable.a1, R.drawable.a5), R.drawable.plato4,
            ...
            Plate(5, "Primero", "Tallarines con langostimos",
                    9.00F, arrayOf(R.drawable.a3), R.drawable.plato5,
            ...
            Plate(6, "Segundo", "Bacalao caramelizado con ensalada",
                    15.00F, arrayOf(R.drawable.a4), R.drawable.plato6,
